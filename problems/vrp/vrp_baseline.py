...
def get_lkh_executable(url="http://www.akira.ruc.dk/~keld/research/LKH-3/LKH-3.0.4.tgz"):
    ...
    cwd = os.path.abspath(os.path.join("problems", "vrp"))
    os.makedirs(cwd, exist_ok=True)

    file = os.path.join(cwd, os.path.split(urlparse(url).path)[-1])
    filedir = "/Users/stevepaul/CVRP/problems/vrp/LKH-3.0.4"#os.path.splitext(file)[0]
...
def solve_lkh_log(executable, directory, name, depot, loc, demand, capacity, grid_size=1, runs=1, disable_cache=True):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--method", default="lkh", help="Name of the method to evaluate, 'lkh' only")
    parser.add_argument("--datasets", default=["../../data/X-n979-k43.pkl"], nargs='+', help="Filename of the dataset(s) to evaluate")
